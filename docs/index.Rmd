...
background-image: url("assets/sound-piles.png")
...
## Figure Categorizations

```{r ugly-bad-wrong-examples}
df <- tibble(
  type = c("A", "B", "C"),
  value = c(3, 5, 4),
  expand = c(4, 5, 4.5)
...
.footnote[
Materials from 'Fundamentals of Data Visualization' by Claus O. Wilke (Part II, Chapter 17)
]
...
comunity policing fails in south (nature article)
young men symmetric dancing attractive to women (nature article)
long term career of phd (nature) (all male committee)
...
- those resources from michael?
- knowing raster () vs vector (svg)
  - save raster as way bigger so then when its small in the figure its better quality? 
